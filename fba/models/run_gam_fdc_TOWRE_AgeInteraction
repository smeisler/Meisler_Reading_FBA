...
metric = 'fdc' # metric to analyze (e.g., log_fc, fd, or fdc)
...
formula <- fdc ~ ti(AGE_DM, k=4, fx=TRUE) + SEX_F + SITE_F + logICV_DM + N_CORR_DM + ti(TOWRE_DM,fx=TRUE,k=4) + ti(AGE_DM,TOWRE_DM,k=4,fx=TRUE)
...
h5_output_path <- gsub(".h5","_TOWRE_age_interaction.h5",h5_output_path)
