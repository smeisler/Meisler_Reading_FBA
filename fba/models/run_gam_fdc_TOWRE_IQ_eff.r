...
metric = 'fdc' # metric to analyze (log_fc, fc, or fdc)
...
WISC_VSI_demean = scale(phenotypes$WISC_VSI)
phenotypes$WISC_VSI_DM <- WISC_VSI_demean
...
formula <- fdc ~ s(AGE_DM, k=4, fx=TRUE) + SEX_F + SITE_F + logICV_DM + N_CORRS_DM + WISC_VSI_DM + TOWRE_DM
